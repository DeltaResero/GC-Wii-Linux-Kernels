***
**_Linux kernel for GameCube/Wii/vWii (Branch Version: 3.0.101)_**
***

This is the 3.0.y GC/Wii Linux kernel branch.  A full copy of this repository can be downloaded by using git to clone the full repository as shown below.
...
To clone only a standalone copy of this branch, either download directly from GitHub from within the matching branch or releases section, or clone the branch with the following command (requires Git version 1.8.X or greater):
    ...
    git clone -b GC-Wii-Linux-Kernel-3.0.y --single-branch https://github.com/DeltaResero/GC-Wii-Linux-Kernels.git
<br>
...
**_Compiled Filesystem/Kernel Demos_**  
	Wii IOS/MINI kernels (3.0.101):  https://spideroak.com/browse/share/DeltaResero/wii/Linux/Kernels/3.0.y/  
